...
import de.jamala.train_announcer.item.ModItems
import de.jamala.train_announcer.block.ModBlockEntities
import de.jamala.train_announcer.item.ModCreativeTabs
...
import de.jamala.train_announcer.network.ModNetworking
import de.jamala.train_announcer.network.ModNetworkingConfigurable
import de.jamala.train_announcer.command.ModCommands
 ...
 */
@Mod(TrainAnnouncer.ID)
object TrainAnnouncer {
    const val ID = "train_announcer"
    ...
    private fun onServerSetup(event: FMLDedicatedServerSetupEvent) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            de.jamala.train_announcer.server.PiperManager.setupPiper()
        }
    }

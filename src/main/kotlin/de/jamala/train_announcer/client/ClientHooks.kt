...
object ClientHooks {
    ...
    fun openAnnouncerScreen(
        ...
        Minecraft.getInstance().setScreen(AnnouncerScreen(pos, currentText, currentVoice, currentLanguage, currentSpeed, currentVolume, currentReverb, currentMaxRange))
    }
    
    fun openConfigurableAnnouncerScreen(pos: BlockPos, be: de.jamala.train_announcer.block.ConfigurableAnnouncerBlockEntity) {
